...
public class wayang extends Activity {
	private EditText jawaban;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.semata_wayang);
	...
	public void cekjawaban(View v){
		String jawabanBenar = "SEMATA WAYANG";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent trans = new Intent(getApplicationContext(),tikus_kantor.class);
			startActivity(trans);
			jawaban.setText("");
			finish();
